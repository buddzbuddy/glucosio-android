...
import org.deabee.android.fragment.OverviewFragment;
import org.deabee.android.object.A1cEstimate;
import org.deabee.android.object.DoubleGraphObject;
import org.deabee.android.tools.GlucosioConverter;
import org.deabee.android.tools.TipsManager;
import org.deabee.android.view.OverviewView;
...
public class OverviewPresenter {
    ...
    public void loadDatabase(boolean isNewGraphEnabled) {
        ...
        this.glucoseMaxValue = dB.getCurrentUser().getCustom_range_max();
        this.glucoseMinValue = dB.getCurrentUser().getCustom_range_min();
    }
    private RequestQueue mRequestQueue;
    private StringRequest mStringRequest;
    private String url = "http://www.mocky.io/v2/597c41390f0000d002f4dbd1";
    public void loadDatabaseFromWeb(){

    }
    private void sendAndRequestResponse() {

        //RequestQueue initialized
        mRequestQueue = Volley.newRequestQueue(((OverviewFragment) view).getActivity());
        ...
        mStringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(((OverviewFragment) view).getActivity(),"Volley :" + response, Toast.LENGTH_LONG).show();//display the response on screen
    ...
    public String getHB1AC() {
        ...
        if (getGlucoseReadingsMonth().size() > 1) {
            if ("percentage".equals(dB.getCurrentUser().getPreferred_unit_a1c())) {
    ...
    public int getUserAge() {
        return dB.getCurrentUser().getAge();
    }
