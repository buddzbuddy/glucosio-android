...
import org.deabee.android.fragment.HistoryFragment;
...
public class HistoryPresenter {
    ...
    public List<String> getFoodReadings() {
        return dB.getFoodReadingAsArray();
    }

    public List<String> getFoodDateTime() {
        return dB.getFoodReadingDateTimeAsArray();
    }

    public List<Long> getFoodId() {
        return dB.getFoodIdAsArray();
    }
    public List<String> getFoodColors() {
        return dB.getFoodColorAsArray();
    }
}
