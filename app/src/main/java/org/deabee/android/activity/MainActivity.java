...
import org.deabee.android.adapter.HomePagerAdapter;
import org.deabee.android.analytics.Analytics;
import org.deabee.android.db.DatabaseHandler;
import org.deabee.android.presenter.ExportPresenter;
import org.deabee.android.presenter.MainPresenter;
import org.deabee.android.tools.LocaleHelper;
import org.deabee.android.view.ExportView;
...
public class MainActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final GlucosioApplication application = (GlucosioApplication) getApplication();
        ...
        if (toolbar != null) {
            ...
            getSupportActionBar().setTitle(R.string.title_top);
            getSupportActionBar().setLogo(R.drawable.ic_deabee_logo);
        }
        ...
        fabAddReading.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //openNewAddActivity(ScreenSlidePagerActivity.class);
            }
        });
        ...
        final PrimaryDrawerItem itemWebLink = new PrimaryDrawerItem().withName("Ссылка для родителей").withIcon(VectorDrawableCompat.create(getResources(), R.drawable.ic_backup_grey_24dp, null)).withSelectable(false).withTypeface(Typeface.DEFAULT_BOLD);
        final PrimaryDrawerItem itemMessages = new PrimaryDrawerItem().withName("Сообщения").withIcon(VectorDrawableCompat.create(getResources(), R.drawable.ic_announcement_grey_24dp, null)).withSelectable(false).withTypeface(Typeface.DEFAULT_BOLD);
        ...
        ImageView view = header.getHeaderBackgroundView();
        if(dbHandler.getAppSettings() != null){
            String server = dbHandler.getAppSettings().IP_ADDRESS;
            new DownloadImageFromInternet(view).execute("https://firebasestorage.googleapis.com/v0/b/amcrud-69b6c.appspot.com/o/drawer_header.png?alt=media&token=da197569-29db-4972-853f-71f97a9aaeb3");
        }
        DrawerBuilder drawerBuilder = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        } else if (drawerItem.equals(itemMessages)) {
                            openMessagesActivity();
                        }
                        else if (drawerItem.equals(itemWebLink)) {

                            String server = dbHandler.getAppSettings().IP_ADDRESS;
                            String url = "http://" + server + ":8090/material-dashboard/#/patients/" + dbHandler.getCurrentUser().getId();

                            /*Intent i = new Intent(Intent.ACTION_VIEW);
                            i.setData(Uri.parse(url));
                            startActivity(i);*/
                            String shareBody = url;//"Here is the share content body";
        ...
        if (isPlayServicesAvailable()) {
            drawerBuilder.addDrawerItems(
                    ...
                    .withSelectedItem(-1)
                    .build();
        } else if (dbHandler.getCurrentUser() != null && dbHandler.getCurrentUser().getUserType() == 1) {
            drawerBuilder.addDrawerItems(
                    itemA1C,
                    itemReminders,
                    //itemExport,
        ...
        ll0 = bottomSheetAddDialogView.findViewById(R.id.ll0);
        ll1 = bottomSheetAddDialogView.findViewById(R.id.ll1);
        expandBtn = bottomSheetAddDialogView.findViewById(R.id.expandBtn);
        collapseBtn = bottomSheetAddDialogView.findViewById(R.id.collapseBtn);
    ...
    private void openDonateIntent() {
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.deabee.org/donate/"));
    ...
    public void onFoodFabClicked(View v) {
        openNewAddActivity(AddFoodActivity.class);
    }

    public void onStepperFabClicked(View v) {
        openNewAddActivity(StepperActivity.class);
    }

    public void onInsulinFabClicked(View v) {
        openNewAddActivity(AddInsulinActivity.class);
    }

    public void onCollapseFabClicked(View v) {
        collapse(ll1);
    ...
    public void onExpandFabClicked(View v) {
        expand(ll1);
        expand(collapseBtn);
    ...
    public void openSupportDialog() {
        ...
        builder.setItems(getResources().getStringArray(R.array.menu_support_options), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                // Forum
                String url = "http://community.deabee.org/";
    ...
    private boolean hasStoragePermissions() {
        ...
        Log.i("DeaBee", "Storage permissions granted.");
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (apiAvailability.isUserResolvableError(resultCode)) {
                ...
                Log.i("DeaBee", "This device is not supported.");
    ...
    private class DownloadImageFromInternet extends AsyncTask<String, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(String... urls) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(getApplicationContext(), "Ошибка при загрузке картинки: " + e.getMessage(), Toast.LENGTH_LONG).show();
            }
            return bimage;
        }
