        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            termsPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    addTermsAnalyticsEvent("DeaBee Terms opened");
                    return false;
                }
            });
            ...
            licencesPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    addTermsAnalyticsEvent("DeaBee Licence opened");
                    return false;
                }
            });
            ...
            ratePref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=org.deabee.android"));
            ...
            feedbackPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    // Open email intent
                    Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:hello@deabee.org"));
            ...
            privacyPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    addTermsAnalyticsEvent("DeaBee Privacy opened");
                    return false;
                }
            });
            ...
            thanksPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    addTermsAnalyticsEvent("DeaBee Contributors opened");
                    return false;
                }
            });
