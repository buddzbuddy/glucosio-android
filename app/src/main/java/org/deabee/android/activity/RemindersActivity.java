...
import org.deabee.android.presenter.RemindersPresenter;
import org.deabee.android.tools.AnimationTools;
...
public class RemindersActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        //for (Integer i = 0; i < 24; i++){
            ...
            String concatenatedId = hourOfDay + "" + minute/* + "" + i*/;
            //cal.add(Calendar.HOUR, i == 0 ? 0 : 1);
            presenter.addReminder(Long.parseLong(concatenatedId), cal.getTime(), label/* + "-" + i*/, "glucose", false, true);
        //}
    }
    ...
    public void showAlarmInfo(String text) {
        //View parentLayout = findViewById(R.id.activity_reminders_root_view);
