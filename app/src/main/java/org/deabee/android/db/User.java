...
public class User extends RealmObject {
    ...
    public User(User copy) {
        ...
        insulinName = copy.insulinName;
        insulinCompany = copy.insulinCompany;
        userType = copy.userType;
    }

    User(int id, String name, String preferred_language, String fullname, int age, String gender, int dType,
         String pUnit, String a1cUnit, String weightUnit, String pRange, double minRange, double maxRange, String insulinName, String insulinCompany, Integer userType) {
        this.id = id;
        this.name = name;
    ...
    public String getInsulinCompany() {
        return insulinCompany;
    }

    public void setInsulinCompany(String insulinCompany) {
        this.insulinCompany = insulinCompany;
    }
