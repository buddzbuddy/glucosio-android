...
import org.deabee.android.adapter.A1cEstimateAdapter;
import org.deabee.android.presenter.OverviewPresenter;
...
public class OverviewFragment extends Fragment implements OverviewView {
    ...
    private void exportGraphToGallery() {
        ...
        boolean saved = chart.saveToGallery("deabee_" + timestamp, 50);
        if (saved) {
